...
SetAcl (Get-ADUser "Donald.Trump") (Get-ADUser "mateo.Pacheco") "GenericAll" "None"
...
SetAcl (Get-ADUser "jesus.puello") (Get-ADGroup "Domain Admins") "GenericAll" "None"
...
SetAcl (Get-ADUser "diego.Montenegro") (Get-ADComputer "NYC") "GenericAll" "None"
...
SetAcl (Get-ADUser "lorenzo.cruz") (Get-ADGroup "Domain Admins") "WriteProperty" "All"
...
SetAclExtended (Get-ADUser "nicolas.Maduro") (Get-ADGroup "Domain Admins") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
...
SetAclExtended (Get-ADUser "diego.Montenegro") (Get-ADGroup "Domain Admins") "WriteProperty" "bf9679c0-0de6-11d0-a285-00aa003049e2" "All"
...
SetAclExtended (Get-ADUser "Donald.Trump") (Get-ADUser "hugo.Chavez") "ExtendedRight" "00299570-246d-11d0-a768-00aa006e0529" "None"
...
SetAcl (Get-ADUser "martin.Osuna") (Get-ADGroup "Domain Admins") "WriteOwner" "None"
...
SetAcl (Get-ADUser "hugo.Chavez") (Get-ADUser "mateo.Pacheco") "GenericWrite" "None"
...
SetAcl (Get-ADUser "Donald.Trump") (Get-ADGroup "RadioCity") "WriteDacl" "None"
